...
export const personalities: Record<PersonalityId, Personality> = {
  magician: {
    ...
    roast: [
      '你把每段恋爱都当成《泰坦尼克号》来演，问题是——你既不是 Rose 也不是 Jack，你是那个在甲板上冻到发抖还以为自己在等浪漫的傻X。',
      '你的恋爱脑已经进化到了第四形态：不仅能给自己加戏，还能给别人加。对方发个「晚安」你就脑补出 80 集韩剧，但现实是——你连对方的真名都打错了。',
      '人家说「我今天有点累」，你的脑内剧场已经演到「ta 是不是出轨了，要不要查手机，分手的话房租怎么分」。冷静点，人家只是想睡觉。',
      '你花在策划惊喜上的时间，够你考个 CPA 了。结果对方说「你怎么又搞这些没用的」，那一刻你的表情，比任何惊喜剧本都精彩。',
      '说实话，你谈恋爱的核心目的不是爱一个人，是爱「在爱一个人的自己」。你需要的那不是对象，是一面能反射你自恋的镜子。',
      '你发的朋友圈就像一本不署名的恋爱小说——全是隐喻、歌词、深夜emo文案，就差把「我很缺爱」四个字写脸上了。',
    ],
  },
  bossCat: {
    id: 'bossCat',
    ...
    roast: [
      '你的感情状态永远是薛定谔的恋爱——不打开盒子你永远不知道自己到底在不在谈。但说实话，大概率是没在谈。',
      '别人暧昧期聊天 500 条，你暧昧期就像在玩「你画我猜」——全是加密信号，对方以为你在用摩斯密码表白。',
      '你的择偶标准大概写了 200 页需求文档，最后一页写着「但如果是真心的，以上全部作废」。所以你到底要什么？你自己也不知道。',
      '你最大的问题不是没人追，而是有人追你第一反应是「ta 到底有什么目的」，然后反向推理三天，最后得出结论「再观察观察」——然后人就没了。',
      '你以为的「高冷」，在别人眼里就是「对我不感兴趣」。你以为的「试探」，在别人眼里就是「渣」。你的沟通方式大概需要一个翻译器。',
      '你把「我喜欢你」憋在心里三年，终于鼓起勇气想说的时候，发现对方已经结婚了。你的 Timing 系统是不是装的 Windows 98？',
    ],
  },
  monster: {
    id: 'monster',
    ...
    roast: [
      '你的恋爱热情大概能点亮一整个小区的路灯，问题是你不挑对象——收银员多看了你一眼你就开始幻想婚后生活了。',
      '你的表白方式基本等于「你看看我！选我选我选我！」——像极了宠物展上疯狂摇尾巴求收养的金毛，丢人吗？丢人。但你也控制不住。',
      '别人吵架冷战三天，你冷战三分钟就受不了了，然后发了一条 500 字小作文道歉——明明不是你的错。你就是恋爱界的自动认罪机器。',
      '你每段感情投入 120%，对方只给 20%。你以为这是「付出感」，不，这是「单方面燃烧」。你不是恋爱怪兽，你是恋爱自焚者。',
      '你谈恋爱的速度比你消化午餐的速度还快。上一个还没忘干净，下一个已经上钩了。你是在谈恋爱还是在收集体验卡？',
      '最可怕的是你分手三天就能蹦出来一句「遇到新的人了！」——你的情感恢复能力要么让人佩服，要么让人害怕。大概率是后者。',
    ],
  },
  hachiko: {
    id: 'hachiko',
    ...
    roast: [
      '你谈的不是恋爱，是精准扶贫——专门资助「感情不顺利人类」。你的对象在你的照顾下活成了残废，而你还觉得这是「爱」。',
      '你的恋爱模式就是「捡到一只流浪猫 → 精心喂养 → 猫吃饱了跑了 → 再捡一只」。你到底是在谈恋爱还是在开流浪动物救助站？',
      '你最大的问题就是把对方当儿子/女儿养，然后困惑「为什么 ta 对我没有心动的感觉」——废话，谁会对自己亲妈心动啊！',
      '别人的分手理由是「我们不合适」，你的分手理由是「我终于意识到我不是你亲妈，而且你也永远长不大」。醒醒吧，你的爱让人窒息。',
      '你以为「对 ta 好」就能留住一个人，但对方要的不是保姆，是伴侣。你把恋爱谈成了家政服务，还觉得自己特伟大。',
      '你最擅长的就是在一段关系中不断降低自己的底线，直到底线低到地下室，然后对方还是走了。你学会了吗？跪着是留不住人的。',
    ],
  },
  treasure: {
    id: 'treasure',
    ...
    roast: [
      '你大概有一份名为「恋爱 KPI 追踪表」的 Excel，里面记录了对方的回复速度、主动次数、情绪波动曲线，甚至还有一个预测模型——但你依然单身。',
      '约会时你脑子里在跑回归分析：「ta 笑了三次，看了手机两次，笑容真诚度约 78.5%，但眼角没有笑纹，存疑。」你是来约会的还是来做法医的？',
      '别人收到情书会感动流泪，你收到情书打开 NLP 分词工具——情感词汇占比 12.3%，句式复杂度偏低，结论：不够真诚。活该你单身。',
      '你最大的浪漫就是把「我有点想你」翻译成「基于近期多巴胺水平波动，我对你的依恋指数上升了 15%，建议维持当前互动频率」。谁能受得了你啊？',
      '你分析了一百种恋爱问题，提出了解决方案 87 个，优化了沟通模型 3 版——但你在感情里最大的问题是：你根本不会心动。你把心跳 120 当成了数据异常。',
      '对方说「爱不需要理由」，你在心里冷笑一声「一切行为都有动机」。你知道为什么你单身吗？因为你连爱情都要过审。',
    ],
  },
  chameleon: {
    id: 'chameleon',
    ...
    roast: [
      '你的恋爱信条是「可以爱我，但别粘我」，然后你发现不粘你的人全都去粘别人了。恭喜你，亲手把所有人推到了别人怀里。',
      '别人谈恋爱是两个人的故事，你谈恋爱是「第一章：相遇；第二章：我需要空间；第三章：做朋友吧」。三集完结，比短剧还短剧。',
      '你的前任们能组一个「被自由放养受害者协会」，定期聚会吐槽你的「突然消失术」「已读不回技能」和「人间蒸发绝招」。',
      '你嘴上说着「我很好不需要爱情」，深夜两点偷偷刷恋爱帖子的手速比谁都快，看到甜宠文还会嘴角上扬。别装了，你比谁都缺爱。',
      '你最大的谎言就是「我一个人也可以」。可以什么？可以一个人去医院挂水的时候自己举着吊瓶上厕所？你的独立是被迫的，你只是太怕受伤了。',
      '你以为「不给对方压力」就是最好的爱，但在对方眼里你就像一阵风——存在过，但抓不住。你的恋爱就是高级版的「来去如风，渣得优雅」。',
    ],
  },
};
